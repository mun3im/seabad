#!/usr/bin/env python3
"""
Stage 2: Extract negative samples from Freefield1010
...
from config import (
    DCASE_DATASETS, STAGE2_OUTPUT_DIR,
    TARGET_SR, CLIP_DURATION, MIN_DURATION,
    process_dcase_file,
)

DATASET_NAME = "Freefield1010"
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('Stage2_rejections.log', mode='w'),
...
def main():
    ...
    logger.info("=" * 70)
    logger.info("STAGE 2: Freefield1010 → NEGATIVE SAMPLES")
    logger.info("=" * 70)
    ...
    with ProcessPoolExecutor() as executor:
        ...
        with tqdm(total=len(futures), desc="Processing Freefield1010", unit="files") as pbar:
    ...
    logger.info("")
    logger.info("=" * 70)
    logger.info("STAGE 2 COMPLETE — Freefield1010")
    logger.info("=" * 70)
