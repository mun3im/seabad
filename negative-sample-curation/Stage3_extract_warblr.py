#!/usr/bin/env python3
"""
Stage 3: Extract negative samples from Warblrb10k
...
- Output: negative/wb/wb-<itemid>-<start_ms:05d>.wav
"""
...
from config import (
    DCASE_DATASETS, STAGE3_OUTPUT_DIR,
    TARGET_SR, CLIP_DURATION, MIN_DURATION,
    process_dcase_file,
)

DATASET_NAME = "Warblrb10k"
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('Stage3_rejections.log', mode='w'),
...
def main():
    ...
    logger.info("=" * 70)
    logger.info("STAGE 3: Warblrb10k → NEGATIVE SAMPLES")
    logger.info("=" * 70)
    ...
    with ProcessPoolExecutor() as executor:
        ...
        with tqdm(total=len(futures), desc="Processing Warblrb10k", unit="files") as pbar:
    ...
    logger.info("")
    logger.info("=" * 70)
    logger.info("STAGE 3 COMPLETE — Warblrb10k")
    logger.info("=" * 70)
