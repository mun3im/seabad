...
STAGE3_FAILED_CSV = "Stage3out_failed_downloads.csv"
STAGE3_LOG_CSV = "Stage3_download_log.csv"
...
STAGE4_REMOVED_CSV = "Stage4_removed_near_duplicates_metadata.csv"
STAGE4_REPORT_TXT = "Stage4_report.txt"
